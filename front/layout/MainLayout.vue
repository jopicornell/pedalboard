...
function goToSimulator (): void {
  router.push({ name: 'PedalSimulator' }).catch(console.error)
}
...
function goToExercises (): void {
  router.push({ name: 'Exercises' }).catch(console.error)
}
</script>
...
<template>
    <div class="pedal-board" :class="pedalBoardClasses">
        ...
        <SideBar v-if="openedSideBar" class="side-bar">
            ...
            <SideBarOption icon="clipboard" @click="goToExercises">
              Exercises
            </SideBarOption>
